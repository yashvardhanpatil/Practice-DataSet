...
<style>
body {
    background-color: #f0f0f0; /https://cdn.dribbble.com/users/1164597/screenshots/5200543/media/8e3084b74e2e72e66627128c3ba52bcc.png?resize=800x600&vertical=center/
}
</style>
"""
...
if st.button("Predict"):
    ...
    if result == 0:
       ...
       st.markdown("<h1 style='color: green;'>Non-Abusive</h1>", unsafe_allow_html=True)
